...
#include <queue>
#include <PS4_traj_builder/PS4_traj_builder.h> //has almost all the headers we need

#include <std_msgs/Float64.h>
#include <std_msgs/Bool.h>
#include <std_srvs/Trigger.h>
#include <dxg397_PS4/path.h>
#include <std_msgs/Float64.h>
...
//    ros::Publisher lidar_dist_publisher_;
    ...
    bool appendPathQueueCB(dxg397_PS4::pathRequest& request,dxg397_PS4::pathResponse& response);

public:
    PS4DesStatePublisher(ros::NodeHandle& nh);//constructor
